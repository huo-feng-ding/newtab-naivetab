...
const EMPHASIS_ONE_KEYS = [
  'F5', 'F6', 'F7', 'F8', 'F13', 'F14', 'F15',
  'Backquote', 'Backspace', 'Tab', 'CapsLock', 'ShiftLeft', 'ShiftRight',
  'ControlLeft', 'MetaLeft', 'AltLeft', 'AltRight', 'MetaRight', 'ControlRight',
  'Fn', 'Insert', 'Delete', 'Home', 'End', 'PageUp', 'PageDown',
]

const EMPHASIS_TWO_KEYS = ['Escape', 'Enter', 'ArrowUp', 'ArrowDown', 'ArrowLeft', 'ArrowRight']

const DEFAULT_CUSTOM_SPACE2 = {
  Space: { size: 3 },
  SpaceSplit1: { size: 3.25 },
}

const DEFAULT_CUSTOM_SPACE3 = {
  Space: { size: 2.25 },
...
const KEYBOARD_TYPE_CONFIG = {
  hhkb: {
    ...
    emphasisOneKeys: EMPHASIS_ONE_KEYS,
    emphasisTwoKeys: EMPHASIS_TWO_KEYS,
    custom: {
      Backslash: { size: 1 },
  ...
  key47: {
    ...
    emphasisOneKeys: ['Backquote', 'Backspace', 'Tab', 'CapsLock', 'ShiftLeft', 'ShiftRight', 'ControlLeft', 'MetaLeft', 'AltLeft', 'AltRight', 'MetaRight', 'ControlRight', 'Fn'],
    emphasisTwoKeys: EMPHASIS_TWO_KEYS,
    custom: {},
    customSpace2: DEFAULT_CUSTOM_SPACE2,
    customSpace3: DEFAULT_CUSTOM_SPACE3,
  },
  key53: {
    isMacOS: false,
    list: [
